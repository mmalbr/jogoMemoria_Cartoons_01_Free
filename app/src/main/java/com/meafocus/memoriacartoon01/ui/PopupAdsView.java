	...
	public PopupAdsView(Context context, AttributeSet attrs) {
		...
		soundOff.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					Shared.activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.meafocus.memoriacartoon01pro")));
				} catch (android.content.ActivityNotFoundException anfe) {
					Shared.activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=com.meafocus.memoriacartoon01pro")));
				}
